...
function Navbar() {
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer">Baker's Hub</a>
  </div>
  ...
  <label className=" px-3 py-2 boader rounded-md  flex items-center gap-2">
  <input type="text" className="grow cutline-none dark:bg-slate-900 dark:text-white" placeholder="Search" />
